...
@allure.epic('UI. Open different pages from main page')
...
def test_open_news_page():
    main_page.open()
    main_page.open_news_page_from_main_page()
...
def test_open_events_page():
    main_page.open()
    main_page.open_events_page_from_main_page()
...
def test_open_legacy_page():
    main_page.open()
    main_page.open_legacy_page_from_main_page()
...
def test_open_wedding_page():
    main_page.open()
    main_page.open_wedding_page_from_main_page()
...
def test_open_victory_routes_page():
    main_page.open()
    main_page.open_victory_routes_page_from_main_page()
...
def test_open_architecture_page():
    main_page.open()
    main_page.open_architecture_page_from_main_page()
...
def test_open_creative_hub_page():
    main_page.open()
    main_page.open_creative_hub_page_from_main_page()
...
def test_open_broadcasts_page():
    main_page.open()
    main_page.open_broadcasts_page_from_main_page()
...
def test_open_photobank_page():
    main_page.open()
    main_page.open_photobank_page_from_main_page()
...
def test_open_photobank_directorate_page():
    main_page.open()
    main_page.open_photobank_directorate_page_from_main_page()
    photobank_page.opened_photobank_page()
...
def test_open_photobank_ria_page():
    main_page.open()
    main_page.open_photobank_RIA_page_from_main_page()
...
def test_open_photobank_exhibitions_russia_page():
    main_page.open()
    main_page.open_photobank_exhibitions_Russia_page_from_main_page()
...
def test_open_for_media_page():
    main_page.open()
    main_page.open_for_media_page_from_main_page()
...
def test_open_fair_page():
    main_page.open()
    main_page.open_fair_page_from_main_page()
...
def test_open_for_developer_page():
    main_page.open()
    main_page.open_for_developer_page_from_main_page()
